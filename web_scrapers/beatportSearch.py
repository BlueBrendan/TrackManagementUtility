                                ...
                                for link in soup.find_all('li', class_="bucket-item ec-item track"):
                                    ...
                                    if link.find('a')['href'] in titleVariations:
                                        ...
                                        if soup == True:
                                            ...
                                            return yearList, BPMList, keyList, genreList
                                        if soup !=False:
                                            yearList, BPMList, keyList, genreList = beatportSingle(soup, yearList, BPMList, keyList, genreList, frame, window, options)
                            #case 2: classic
                                ...
                                if message is None:
                                    ...
                                    # verify that the page is correct
                                        ...
                                        if trackRemix != '' and '(' in title and ')' in title:
                            ...
                            #case 3: track
                                ...
                                if link is not None:
                                    ...
                                    if trackMix != '' and 'original' not in trackMix.lower() and '(' in title and ')' in title:
                                        ...
                                        if mismatch == False:
                                            yearList, BPMList, keyList, genreList, imageCounter = beatportSingle(soup, yearList, BPMList, keyList,genreList, frame, window, options, imageCounter)
                                    else:
                                        yearList, BPMList, keyList, genreList, imageCounter = beatportSingle(soup, yearList, BPMList, keyList, genreList, frame, window, options, imageCounter)
    return yearList, BPMList, keyList, genreList, imageCounter

def beatportSingle(soup, yearList, BPMList, keyList, genreList, frame, window, options, imageCounter):
