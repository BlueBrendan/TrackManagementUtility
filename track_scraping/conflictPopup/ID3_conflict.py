...
def ID3_conflict(audio, track, options, initialCounter, imageCounter, informalTagDict, webScrapingWindow):
    ...
    if audio["TDRC"] != '' or audio["TBPM"] != '' or audio["TKEY"] != '' or audio["TCON"] != '':
        ...
        if options["Reverse Image Search (B)"].get() == True and imageCounter >= 1:
            ...
            tk.Label(conflictFrame, text="Current artwork", font=("Proxima Nova Rg", 13), fg="white", bg=bg).pack(pady=(20, 10))
            ...
            tk.Button(conflictFrame, text="Select", font=("Proxima Nova Rg", 11), fg="white", bg=bg, command=lambda: saveImage(track, audio, conflictFrame, webScrapingWindow)).pack(side="top",
                                                                                                                                                                                     pady=(10, 10))
